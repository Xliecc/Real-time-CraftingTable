 ...
 * {@code LevelRenderState.blockEntityRenderStates}，正常视图与 Iris 阴影 pass 都会用
 * 标准路径（{@code BlockEntityRenderDispatcher.render}）渲染它——与附魔台/可视化工作台
 ...
 * {@code BlockEntityRenderDispatcherMixin} 在 {@code render} HEAD 直接手工调用
 * {@link CraftingPreviewRenderer#renderPreviewGeometry} 接管。参见
 * {@code BlockEntityRenderDispatcherMixin} 类注释。
 */
